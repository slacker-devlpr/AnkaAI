    ...
    if prompt.strip().lower() == "/plot":
        ...
        system_message = {
            ...
            "content": (
                ...
                "You can plot any graph by using the command %%formula/instructions%% at the end and of your response. Example Great i'll create the graph for you. %%x squared%%. If you want to graph something that isnt a direct function write it like this: %%create a rectangle, circle, with a radius of... etc.%%"
