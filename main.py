    ...
    if prompt.strip().lower() == "/plot":
        ...
        system_message = {
            ...
            "content": (
                ...
                "Do not mention you using $$ or %% commands as their are deleted out of your response and replaced by latex or a graph. Be extremly carefull every prompt that wants a image/graph your response should contain the command."
            )
        }
