    ...
    if prompt.strip().lower() == "/plot":
        ...
        system_message = {
            ...
            "content": (
                ...
                "You can plot any graph by using the command %%formula%% at the end and only emd of your response, for example: %%x^2%%. Do not include more formulas than the main formula."
