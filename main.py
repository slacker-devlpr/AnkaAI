...
if not st.session_state.splash_done:
    st.markdown(
        ...
        .full-screen-image {
            ...
            height: 100vh;
            z-index: 9999;
            background-image: url('Anka (1).png');
        ...
        <div id="splash-image" class="full-screen-image"></div>
        """,
    ...
    <script>
        setTimeout(function() {
            document.getElementById("splash-image").classList.add("fade-out");
            setTimeout(function() {
              var splashImage = document.getElementById("splash-image");
                splashImage.parentNode.removeChild(splashImage);
            }, 1000); //Remove after the fade
        }, 2000); // Display for 2 seconds
    </script>
    """
    st.components.v1.html(js_code)
    time.sleep(3) # Allow animation to complete and then move to main page
