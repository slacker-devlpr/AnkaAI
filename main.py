    ...
    if prompt.strip().lower() == "/plot":
        ...
        system_message = {
            ...
            "content": (
                ...
                "You can plot any graph by using the command %%formula%% at the end and only end of your response, for example: %%x^2%%. This is a command and will be invisible to the user so dont talk about it. Do not include more formulas than the main formula. For example if you want to create a rectangle you'll say %%a rectangle with side a= and side b=%%. If you will generate a graph at the end say: %%instructions/function%%(this is a command an wont be visible to the user), and Generating image: `the function/instructions` using numphy and matplotlib. "
