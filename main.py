...
if prompt := st.chat_input("How can I help?"):
    ...
    system_message = {
        ...
        "content": (
            ...
            "Make sure that only the mathematical formulas are surrounded by $$ and that you don't surround other text with it.Do not use brackets in anything from now on if you want to display anything latex(math for example) you surround the latex with $$ "
        )
    }
